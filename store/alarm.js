...
export const actions = {
  setAlarmAudio({ rootState, state, commit }, dataURL) {
    commit("SET_ALARM_AUDIO", dataURL);

    // Workaround to object properties not being reactive
    state.audioObject.onplay = () => {
      if (rootState.timebox.pauseBetweenTimeboxes) {
